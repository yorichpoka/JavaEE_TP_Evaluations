                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-9">
                            <h5 class="card-title">
                                <i class="fa fa-cogs"></i> Teacher management
                            </h5>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result.isSuccess) {
                            ...
                            $('#form_matricule').val(result.data.matricule);
                            $('#form_firstname').val(result.data.firstname);
                            $('#form_lastname').val(result.data.lastname);
                            $('#form_address').val(result.data.address);
                            $('#form_mobile_phone').val(result.data.mobile_phone);
                            $('#form_email').val(result.data.email);
                            $('#form_birthday').val(moment(result.data.birthday).format('DD/MM/YYYY'));
                            $('#form_id_user').val(result.data.user.id);
